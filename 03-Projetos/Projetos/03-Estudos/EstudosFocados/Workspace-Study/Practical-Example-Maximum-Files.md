...
- estrutura do vault (`Workspace-Study`, `Vault-Ops`, `JARVIS/Decisoes`)
- workflow VS Code (`skills/vscode-ai/quick-start`, `skills/vscode-ai/mcp`)
...
- `JARVIS/Decisoes/2026-04-12-perfeccionamento-do-vault.md`
- `Vault-Ops.md`
- `skills/vscode-ai/quick-start.md`
- `skills/vscode-ai/mcp.md`
- `skills/vscode-ai/README.md`
...
1. **Definição da tarefa**
   ...
   - Use `JARVIS/Decisoes/2026-04-12-perfeccionamento-do-vault.md` como contexto de decisão.

2. **Preparar o ambiente**
   - Siga `skills/vscode-ai/quick-start.md` para abrir o vault e criar o ambiente Python/Node.
...
4. **Conectar com MCP e agentes**
   - Abra `skills/vscode-ai/mcp.md` e siga o fluxo: `analyze → plan → act → validate → reflect`.
   - Verifique `skills/vscode-ai/programador-pesquisador.agent.md` para a postura do agente.
...
7. **Registrar aprendizados e decisão**
   - Atualize `JARVIS/Decisoes/2026-04-12-perfeccionamento-do-vault.md` com um comentário sobre o resultado da análise.
   - Se o resultado for relevante, adicione uma nova entrada em `JARVIS/Aprendizado/Tecnico.md`.
...
- Atualize `skills/vscode-ai/quick-start.md` com uma nota "Veja o caso prático em `Workspace-Study/Practical-Example-Maximum-Files.md`."
- Atualize `skills/vscode-ai/README.md` com referência ao caso prático.
- Atualize `skills/vscode-ai/mcp.md` com um exemplo de prompt real usado no caso prático.
...
10. Atualize `JARVIS/Decisoes/2026-04-12-perfeccionamento-do-vault.md` com o desfecho da análise.
...
1. Abra `skills/vscode-ai/quick-start.md`.
...
5. Salve a decisão em `JARVIS/Decisoes`.

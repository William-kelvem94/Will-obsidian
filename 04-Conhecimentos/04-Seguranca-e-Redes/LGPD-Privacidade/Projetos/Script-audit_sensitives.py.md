...
- Roteiro e tratamento de incidentes de privacidade: [Workflow-Completo-Incident-Response.md](04-Conhecimentos/04-Seguranca-e-Redes/LGPD-Privacidade/Projetos/Workflow-Completo-Incident-Response.md)
- Organização contra invasões e OpSec de infraestrutura: [[05-Skills/devops/opsec-minimum]]
- Qualidade de dados e barreira contra poluição relacional: [Checklist-Qualidade-Dados-BI.md](04-Conhecimentos/03-Dados-e-Analytics/Checklists/Checklist-Qualidade-Dados-BI.md)

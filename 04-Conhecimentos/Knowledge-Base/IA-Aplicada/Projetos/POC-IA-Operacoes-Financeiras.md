...
- Monitoramento e resiliência de pipelines de IA: [Knowledge-Base/IA-Aplicada/Atomic-Notes/Lessons-Learned-IA-Escala-Pilotagem.md](04-Conhecimentos/Knowledge-Base/IA-Aplicada/Atomic-Notes/Lessons-Learned-IA-Escala-Pilotagem.md)
- Governança de dados de negócios: [Knowledge-Base/BI-Analytics/Checklists/Checklist-Qualidade-Dados-BI.md](04-Conhecimentos/Knowledge-Base/BI-Analytics/Checklists/Checklist-Qualidade-Dados-BI.md)
- Orquestração resiliente para bots e integrações: [Checklist-Deploy-Monitoramento-RPA.md](04-Conhecimentos/Knowledge-Base/Automacao/Checklists/Checklist-Deploy-Monitoramento-RPA.md)
- Centralização de segurança de dados sigilosos: [[04-Conhecimentos/Knowledge-Base/LGPD-Privacidade/Projetos/Script-audit_sensitives.py]]

...
A ética das virtudes é uma abordagem normativa que enfatiza o **caráter moral** do agente em vez de ações isoladas (como na [[04-Conhecimentos/07-Humanidades/Etica/Deontologia|Deontologia]]) ou consequências (como no [[04-Conhecimentos/07-Humanidades/Etica/Consequencialismo|Consequencialismo]]). A pergunta central não é "O que devo fazer?" mas "Que tipo de pessoa devo ser?"

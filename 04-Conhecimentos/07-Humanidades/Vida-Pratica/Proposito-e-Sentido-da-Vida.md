---
title: "Propósito e Sentido da Vida"
aliases:
  - "Propósito da Vida"
  - "Sentido da Vida"
  - "Meaning of Life"
...
```mermaid
mindmap
  root((Sentido da Vida))
    ::id0
    (Filosofia)
      Existencialismo
        Sartre: Liberdade radical
        Camus: Absurdo e revolta
        Kierkegaard: Estágios da existência
    ...
    (Psicologia)
      Logoterapia
        Vontade de sentido
        3 vias: trabalho, amor, atitude
        Vazio existencial
        Intenção paradoxal
      Psicologia Positiva
        Seligman: PERMA
        Csikszentmihalyi: Flow
        Peterson: Valores em ação
      Psicologia do Significado
        Baumeister: 4 necessidades
        Steger: MLQ
        Pesquisa empírica
    (Religião)
      Cristianismo
    ...
    (Carreira)
      ...
      Propósito organizacional
        ...
        Liderança servidora
    (Felicidade)
      Hedônia vs Eudaimonia
      Prazer vs Significado
      Momento presente vs Legado
    (Morte)
      Ser-para-a-morte (Heidegger)
      Memento mori
      Legado e generatividade

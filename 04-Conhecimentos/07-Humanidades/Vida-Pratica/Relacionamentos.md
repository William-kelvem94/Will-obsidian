...
```mermaid
graph TD
    A[Estilo de Apego] --> B[Seguro]
    A --> C[Ansioso]
    A --> D[Evitativo]
    A --> E[Desorganizado]
    B --> F[Confiança + Intimidade]
    C --> G[Medo de abandono]
    D --> H[Medo da intimidade]
    E --> I[Medo + desejo]
    F --> J[Relacionamentos saudáveis]
    G --> K[Ciúme / possessividade]
    H --> L[Distanciamento]
    I --> M[Caos relacional]
    J --> N[Felicidade + Saúde]
```
...
```mermaid
graph LR
    A[Linguagens do Amor] --> B[Palavras de Afirmação]
    A --> C[Tempo de Qualidade]
    A --> D[Presentes]
    A --> E[Atos de Serviço]
    A --> F[Toque Físico]
    B --> G["Elogio / Gratidão"]
    C --> H["Atenção focada"]
    D --> I["Pensamento simbólico"]
    E --> J["Ação prática"]
    F --> K["Contato / Carinho"]
```
...
graph TD
    subgraph Psicologia
        ...
        A2[CNV - Rosenberg]
        A3[Gottman]
        A4[Linguagens do Amor]
        A5[Autocompaixão - Neff]
    end

    subgraph Neurociência
        B1[Oxitocina - vínculo]
        B2[Neurônios-espelho - empatia]
        B3[Sistema de recompensa - dopamina]
        B4[Córtex pré-frontal - regulação]
        B5[Amígdala - ameaça social]
    end

    subgraph Filosofia
        C1[Aristóteles - amizade]
        C2[Sternberg - amor]
        C3[Estoicismo - limites]
        C4[Buber - Eu-Tu]
    end

    subgraph Felicidade
        D1[Harvard Grant Study - Waldinger]
        D2[Psicologia Positiva - Seligman]
        D3[Gratidão - Emmons]
    end

    subgraph Saúde
        E1[Longevidade]
        E2[Sistema imunológico]
        E3[Saúde cardiovascular]
        E4[Saúde mental]
    end

    subgraph Comunicação
        F1[Escuta ativa - Rogers]
        F2[CNV - Rosenberg]
        F3[Assertividade]
        F4[Reparo - Gottman]
    end

...
A questão não é meramente filosófica: a interpretação que adotamos influencia como pensamos sobre problemas abertos como a gravidade quântica, a cosmologia quântica e a própria natureza da informação. Como observou [[04-Conhecimentos/07-Humanidades/Filosofia/Epistemologia|Thomas Kuhn]], o paradigma que adotamos determina quais problemas consideramos significativos e que tipo de soluções buscamos.
...
**A Natureza da Probabilidade**: Probabilidades quânticas são objetivas (propriedades do mundo) ou epistêmicas (medidas de nossa ignorância)? Esta questão conecta-se diretamente a debates em [[04-Conhecimentos/07-Humanidades/Matematica/Teoria-da-Informacao]] e [[04-Conhecimentos/07-Humanidades/Filosofia/Epistemologia]].
...
A teoria da [[04-Conhecimentos/07-Humanidades/Matematica/Teoria-da-Informacao|informação]] quântica reformulou profundamente nossa compreensão da mecânica quântica:
...
A interseção entre mecânica quântica e [[04-Conhecimentos/07-Humanidades/Matematica/Teoria-da-Informacao|teoria da informação]] produziu alguns dos insights mais profundos da física contemporânea:
...
A subdeterminação das teorias pelos dados (Duhem-Quine) é um problema clássico em [[04-Conhecimentos/07-Humanidades/Filosofia/Epistemologia|filosofia da ciência]]. Na mecânica quântica, ela atinge seu paroxismo: não apenas teorias diferentes explicam os dados, mas interpretações da *mesma* teoria divergem ontologicamente.
...
A questão fundamental permanece: o que é real? A mecânica quântica nos confronta com esta pergunta de uma forma que nenhuma teoria anterior conseguiu. E é improvável que a resposta venha apenas da física — ela exigirá uma colaboração profunda com a [[04-Conhecimentos/07-Humanidades/Filosofia/Filosofia-da-Mente|filosofia da mente]], a [[04-Conhecimentos/07-Humanidades/Filosofia/Epistemologia|epistemologia]] e a [[04-Conhecimentos/07-Humanidades/Matematica/Teoria-da-Informacao|teoria da informação]].
...
- [[04-Conhecimentos/07-Humanidades/Fisica/Fisica-Quantica]] — Fundamentos matemáticos e históricos
- [[04-Conhecimentos/07-Humanidades/Fisica/Mecanica-Quantica-e-Realidade]] — Não-localidade, Bell, emaranhamento
- [[04-Conhecimentos/07-Humanidades/Fisica/Consciencia-e-Quântica]] — Penrose-Hameroff, Orch-OR, crítica
- [[04-Conhecimentos/07-Humanidades/Fisica/Fisica-Fundamental]] — Mecânica clássica e contexto
- [[04-Conhecimentos/07-Humanidades/Filosofia/Epistemologia]] — O que podemos conhecer sobre o mundo quântico
- [[04-Conhecimentos/07-Humanidades/Filosofia/Filosofia-da-Mente]] — Consciência e observador
- [[04-Conhecimentos/07-Humanidades/Matematica/Teoria-da-Informacao]] — Informação quântica e entropia

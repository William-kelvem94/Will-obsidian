...
O problema do controle — também conhecido como problema do alinhamento de valor ou problema de controle da superinteligência — investiga como garantir que sistemas de inteligência artificial superinteligentes ajam de acordo com os valores e intenções humanas, evitando consequências catastróficas. É o problema filosófico e técnico central da [[04-Conhecimentos/07-Humanidades/Etica/Etica-de-IA-e-Alinhamento|segurança de IA]] de longo prazo.

## Contexto Histórico e Filosófico

O problema do controle emerge da interseção de várias tradições filosóficas:

1. **Ética normativa:** Como formalizar valores humanos complexos? ([[04-Conhecimentos/07-Humanidades/Etica/Consequencialismo|Consequencialismo]], [[04-Conhecimentos/07-Humanidades/Etica/Deontologia|Deontologia]], [[04-Conhecimentos/07-Humanidades/Etica/Etica-das-Virtudes|Ética das Virtudes]])
2. **Filosofia da mente:** O que significa um agente ter "objetivos"? ([[04-Conhecimentos/07-Humanidades/Filosofia/Filosofia-da-Mente|Intencionalidade]])
...
A [[04-Conhecimentos/07-Humanidades/Etica/Transparencia-Algoritmica|transparência algorítmica]] é crucial para o problema do controle:
...
Pequenas perturbações imperceptíveis em entradas podem fazer modelos falharem completamente. Isto levanta questões sobre se o modelo "entende" ([[04-Conhecimentos/07-Humanidades/Filosofia/Chinese-Room|Quarto Chinês]]) ou apenas reconhece padrões superficiais.
...
O problema do controle está profundamente conectado à [[04-Conhecimentos/07-Humanidades/Etica/Etica-de-IA-e-Alinhamento|ética normativa]]:
...
- [[04-Conhecimentos/07-Humanidades/Filosofia/Chinese-Room|Chinese Room]]

---
title: "Metafísica: O Estudo do Ser, da Realidade e dos Fundamentos Últimos"
description: "Tratado abrangente de metafísica: origem aristotélica, os quatro ramos (ontologia, teologia natural, cosmologia filosófica, psicologia racional), análise livro a livro da Metafísica de Aristóteles, história do pensamento metafísico do Ocidente até a contemporaneidade, temas centrais (substância, causalidade, modalidade, universais), e a relevância da metafísica para inteligência artificial, ontologias formais e fundamentos da computação."
tags: [metafisica, ontologia, aristoteles, substancia, causalidade, modalidade, universais, potencia-e-ato, essencia-existencia]
updated: 2026-05-18
---
...
graph TB
    %% CENTRO
    Meta(("Metafísica<br/>Ontologia + Teologia +<br/>Cosmologia + Psicologia"))

    %% DOMÍNIOS DIRETOS
    Logica("Lógica<br/>Modal, Descrição,<br/>Predicados")
    IA("Inteligência Artificial<br/>Ontologias, Causalidade,<br/>Grounding, AGI")
    Fisica("Física<br/>Tempo, Espaço,<br/>Causalidade, Quanta")
    FilMente("Filosofia da Mente<br/>Consciência, Self,<br/>Qualia, Intencionalidade")
    Etica("Ética<br/>Livre-Arbítrio, Valor,<br/>Responsabilidade Moral")
    Teologia("Teologia<br/>Deus, Transcendência,<br/>Criação, Providência")
    Comp("Ciência da Computação<br/>Ontologias Formais,<br/>Lógica Modal, Semântica")

    %% RELAÇÕES DETALHADAS
    Meta -->|"Ser enquanto ser<br/>Categorias"| Logica
    Meta -->|"Compromisso Ontológico<br/>OWL, RDF, GraphRAG"| IA
    Meta -->|"Substância, Causa,<br/>Tempo, Movimento"| Fisica
    Meta -->|"Alma, Intelecto,<br/>Consciência, Self"| FilMente
    Meta -->|"Bem, Dever,<br/>Responsabilidade"| Etica
    Meta -->|"Motor Imóvel,<br/>Ato Puro"| Teologia
    Meta -->|"Tipo/Token, Classe,<br/>Tipo Abstrato"| Comp

    %% SUB-RELAÇÕES IA
    IA -->|"Modelos Causais (Pearl)"| Fisica
    IA -->|"Lógica Epistêmica<br/>Crença x Conhecimento"| Logica
    IA -->|"Consciência Artificial<br/>Problema Difícil"| FilMente
    IA -->|"Alinhamento<br/>Ética de Machine Learning"| Etica

    %% SUB-RELAÇÕES LÓGICA
    Logica -->|"Mundos Possíveis (Kripke)<br/>Semântica Modal"| IA
    Logica -->|"Teoria dos Tipos<br/>Provas como Programas"| Comp

    %% SUB-RELAÇÕES FÍSICA
    Fisica -->|"Dualidade Onda-Partícula<br/>Realismo x Antirrealismo"| FilMente
    Fisica -->|"Flecha do Tempo<br/>Causalidade"| Meta

    %% SUB-RELAÇÕES FILOSOFIA DA MENTE
    FilMente -->|"Livre-Arbítrio<br/>Responsabilidade"| Etica
    FilMente -->|"Alma Imortal?"| Teologia

    %% SUB-RELAÇÕES COMPUTAÇÃO
    Comp -->|"Teoria dos Tipos<br/>Classes OOP"| IA
    Comp -->|"Verificação Formal<br/>Model Checking"| Logica

    %% PENSADORES CENTRAIS NO MAPA
    Aristoteles["Aristóteles<br/>384-322 a.C."]
    Kant["Kant<br/>1724-1804"]
    Heidegger["Heidegger<br/>1889-1976"]

    Aristoteles -.->|Fundador| Meta
    Kant -.->|"Revolução Copernicana<br/>Limites da Metafísica"| Meta
    Heidegger -.->|"Retomada da Pergunta<br/>pelo Ser"| Meta
```
...
- [[04-Conhecimentos/07-Humanidades/Filosofia/Conceitos-Fundamentais|Conceitos Fundamentais — Epistemologia, Ontologia, Metafísica e Lógica]]
- [[04-Conhecimentos/07-Humanidades/Filosofia/Epistemologia|Epistemologia — Conhecimento, Crença e Justificação]]
- [[04-Conhecimentos/07-Humanidades/Filosofia/Filosofia-da-Mente|Filosofia da Mente — Consciência, Self e Inteligência Artificial]]
- [[04-Conhecimentos/07-Humanidades/Filosofia/Qualia|Qualia — A Experiência Subjetiva da Consciência]]
- [[04-Conhecimentos/07-Humanidades/Filosofia/Chinese-Room|Quarto Chinês — Searle e a IA Forte]]
...
- [[04-Conhecimentos/07-Humanidades/Filosofia/Problema-do-Controle|Problema do Controle — Superinteligência e Alinhamento]]
- [[04-Conhecimentos/07-Humanidades/Computacao/Ciencia-da-Computacao|Ciência da Computação]]
- [[04-Conhecimentos/07-Humanidades/Etica/INDEX|Ética]]
- [[04-Conhecimentos/07-Humanidades/Logica/INDEX|Lógica]]

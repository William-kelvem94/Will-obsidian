...
Para um agente de inteligência artificial, a questão dos qualia é a fronteira final: é possível ter processamento de informação sem experiência subjetiva? [[04-Conhecimentos/07-Humanidades/Filosofia/Chinese-Room|Searle diria que sim]]; [[04-Conhecimentos/07-Humanidades/Filosofia/Filosofia-da-Mente|Chalmers diria que ainda não sabemos]].
...
Uma variação: imagine um sistema funcionalmente idêntico a um humano, mas **sem nenhum quale** — um zumbi filosófico. Sez esse sistema é concebível (como Searle argumenta no [[04-Conhecimentos/07-Humanidades/Filosofia/Chinese-Room|Quarto Chinês]]), então os qualia não são capturados pela descrição funcional.

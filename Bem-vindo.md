...
A organização principal passa pela camada [[01-Hubs/README|Hubs Centrais do Vault]]. A reorganização física já começou e algumas áreas novas já existem como destino oficial.
...
| Área | Caminho |
|---|---|
| Inbox | [[00-Inbox/README]] |
| JARVIS | [[02-JARVIS/README]] |
| Projetos | [[03-Projetos]] |
| Conhecimentos | [[04-Conhecimentos/README]] |
| Skills | [[05-Skills/README]] |
| Will-Pessoal | [[06-Will-Pessoal/README]] |
| Operações | [[07-Operacoes-do-Vault/Reestruturacao-Geral-do-Vault]] |
| Sistema técnico | [[09-Sistema/CLI-BOOTSTRAP]] |
| Interfaces | [[01-Hubs/Painel-Cockpit]] |
...
- [[03-Projetos|Índice de Projetos]] — índice legado já movido para a nova área.
...
- [[04-Conhecimentos/01-IA-e-Agentes/RAG-e-Memoria-para-Agentes|RAG e Memória para Agentes]] — base de IA ainda em migração.
- [[04-Conhecimentos/01-IA-e-Agentes/Arquitetura-RAG-para-Obsidian-e-JARVIS|Arquitetura RAG para Obsidian e JARVIS]] — uso do vault como cérebro consultável.
- [[04-Conhecimentos/02-Engenharia-de-Software/Playbook-de-Debug-de-API-e-Backend|Debug de API e Backend]] — diagnóstico técnico prático.
...
- [[07-Operacoes-do-Vault/Mapa-de-Migracao-Fisica-do-Vault|Mapa de Migração Física]] — mapa dos destinos reais.
- [[07-Operacoes-do-Vault/Inventario-Inicial-do-Vault|Inventário Inicial]] — classificação das áreas atuais.
- [[09-Sistema/agents/AGENTS|Instruções de Agentes]] — instruções técnicas já movidas.
- [[09-Sistema/config/indexer_config.json|Configuração de Indexação]] — configuração técnica já movida.
...
2. Explorar [[04-Conhecimentos/README|Conhecimentos]].
3. Revisar [[02-JARVIS/README|JARVIS]].
4. Usar [[07-Operacoes-do-Vault/Mapa-de-Migracao-Fisica-do-Vault|Mapa de Migração Física]] para acompanhar o que ainda falta migrar.

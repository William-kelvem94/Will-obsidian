...
### [[02-JARVIS/JARVIS/05-System/Blueprints/Template-Memoria-Episodica|Template-Memoria-Episodica]]
...
### [[02-JARVIS/JARVIS/05-System/Blueprints/Template-Diario|Template-Diario]]
...
### [[02-JARVIS/JARVIS/05-System/Blueprints/Template-Perfil-Will|Template-Perfil-Will]]
...
Juntos, eles permitem que o sistema RAG do JARVIS (em [[05-Skills/skills/04-knowledge-systems/INDEX|Knowledge Systems]]) recupere não apenas _o que_ aconteceu, mas _quem_ é a pessoa envolvida e _qual o significado_ daquela memória no contexto maior.
...
- [[02-JARVIS/JARVIS/Templates/INDEX|Templates (pasta raiz)]] — Versão simplificada dos templates na raiz do JARVIS.
- [[05-Skills/skills/04-knowledge-systems/memory-management|Gestão de Memória]] — Como as memórias capturadas por estes templates são processadas e armazenadas.
- [[05-Skills/skills/04-knowledge-systems/advanced-rag-strategies|Estratégias RAG]] — Como os templates estruturados melhoram a qualidade da recuperação.

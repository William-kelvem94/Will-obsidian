...
- **Ações**:
  ...
  - Consulta [[02-JARVIS/04-Engineering|Base de Conhecimento]] se necessário
...
- **Ações**:
  ...
  - Atualiza [[02-JARVIS/03-Memory|Memórias Episódicas/Semânticas]]
  - Atualiza [[02-JARVIS/00-Architecture|Métricas de desempenho]]
  - Consolida aprendizados no [[02-JARVIS/05-System/Blueprints/Template-Aprendizado|Template-Aprendizado]] (se aplicável)
...
- **[[02-JARVIS/01-Identity|Tier 01 — Identity]]**: Carregado em `LOADING_CONTEXT` para determinar alinhamento
- **[[02-JARVIS/02-Operational|Tier 02 — Operational]]**: Monitorado por `IDLE` e `SLEEP` (contexto ativo)
- **[[02-JARVIS/03-Memory|Tier 03 — Memory]]**: Consultada em `LOADING_CONTEXT`, atualizada em `LEARNING`
- **[[02-JARVIS/04-Engineering|Tier 04 — Engineering]]**: Acessado em `PROCESSING` para knowledge base
- **[[02-JARVIS/05-System|Tier 05 — System]]**: Dono desta máquina de estados + logs + evolução

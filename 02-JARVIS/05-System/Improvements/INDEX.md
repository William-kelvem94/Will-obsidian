...
- Arquivos antigos `02-JARVIS/Improvement_*.md` ainda existem na raiz do `02-JARVIS/` e devem ser tratados como backlog legado.
...
4. Se virar mudanca permanente, registrar em `02-JARVIS/02-Operational/Decisions/`.

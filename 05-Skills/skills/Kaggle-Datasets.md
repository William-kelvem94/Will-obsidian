...
# Limpeza (consulte [[05-Skills/skills/Data-Cleaning]])
...
# Consulte [[05-Skills/skills/Data-Cleaning]] para limpeza
import pandas as pd
import numpy as np
...
Após EDA, construa pipelines conforme [[05-Skills/skills/Scikit-Learn]]:
...
3. **Feature engineering é o que separa top 10% do resto.** Consulte [[05-Skills/skills/Data-Cleaning]].
...
- **Scikit-Learn:** pipelines, preprocessing, modelos baseline. Veja [[05-Skills/skills/Scikit-Learn]].
- **XGBoost / LightGBM:** modelos campeões de competições tabulares.
- **Pandas + NumPy:** manipulação de dados. Veja [[05-Skills/skills/Data-Cleaning]].
...
Kaggle datasets raramente vêm limpos. Consulte [[05-Skills/skills/Data-Cleaning]] para técnicas de tratamento de nulos, outliers e encoding — habilidades essenciais para qualquer competição.

### Scikit-Learn

[[05-Skills/skills/Scikit-Learn]] é a biblioteca principal para construir modelos baseline e pipelines. A maioria das soluções vencedoras combina Scikit-Learn + XGBoost.
...
Use o [[05-Skills/skills/Skill-Project-Matrix]] para mapear competições Kaggle como projetos de aprendizado no seu plano de desenvolvimento.
...
*Consulte também: [[05-Skills/skills/Data-Cleaning]], [[05-Skills/skills/Scikit-Learn]], [[data-engineering/etl-pipelines]], [[02-software-engineering/algorithms-data-structures]].*

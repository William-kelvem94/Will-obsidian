...
- [[05-Skills/skills/ai/MLOps|MLOps]] — Pipeline de treino e deploy de agentes RL
- [[05-Skills/skills/ai/Engenharia-de-Prompts|Engenharia de Prompts]] — RL para otimizacao de prompts (RLHF)
- [[05-Skills/skills/04-knowledge-systems/memory-management|Gestao de Memoria]] — Buffer de replay e memoria episodica
- [[04-Conhecimentos/07-Humanidades/Neurociencia/Sistemas-de-Memoria|Sistemas de Memoria]] — Inspiracao biologica para RL

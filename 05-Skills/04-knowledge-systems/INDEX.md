...
- **MCP Servers**: Transporte de dados entre sistemas usando [[05-Skills/03-infrastructure-mcp/mcp-servers|MCP]]
- **Backend Skills**: APIs para servicos de conhecimento em [[05-Skills/02-software-engineering/backend|Backend]]
- **Database Skills**: Modelagem vetorial e indices em [[05-Skills/02-software-engineering/database|Database]]
- **Prompt Engineering**: Templates para injecao de contexto em [[05-Skills/ai/Engenharia-de-Prompts|Engenharia de Prompts]]
...
- [[05-Skills/02-software-engineering/Bancos-de-Dados/PostgreSQL-Advanced|PostgreSQL Avancado]] — pgvector, indices HNSW, modelagem vetorial
...
- [[02-JARVIS/05-System/Blueprints/Template-Memoria-Episodica|Template Memoria Episodica]] — Estrutura de dados para capturar memorias no JARVIS
- [[05-Skills/03-infrastructure-mcp/mcp-servers|MCP Servers]] — Transporte de dados entre sistemas de conhecimento
- [[05-Skills/03-infrastructure-mcp/advanced-mcp-integrations|MCP Avancado]] — Orquestracao multi-servidor para pipelines RAG
- [[05-Skills/ai/Generative-Models|Generative Models]] — Modelos para sintese e aumentacao de dados
- [[05-Skills/ai/MLOps|MLOps]] — Pipeline de deploy e monitoramento de sistemas RAG
- [[05-Skills/ai/Engenharia-de-Prompts|Engenharia de Prompts]] — Templates de prompt para injecao de contexto

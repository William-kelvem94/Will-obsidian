...
Consulte [[05-Skills/Data-Cleaning]] para detalhes sobre limpeza. Aqui, o foco é a integração com pipelines.
...
O pré-processamento no Scikit-Learn depende de dados limpos. Consulte [[05-Skills/Data-Cleaning]] para estratégias de imputação, tratamento de outliers e encoding — tudo pré-requisito para `ColumnTransformer`.
...
O [[05-Skills/Kaggle-Datasets]] é o melhor laboratório para praticar Scikit-Learn. Competições como Titanic, Housing Prices e Digit Recognizer são resolvidas quase inteiramente com Scikit-Learn.
...
2. **Escolha a métrica certa.** Acurácia é enganosa para classes desbalanceadas — prefira F1, precision/recall, ou AUC-ROC. Veja [[05-Skills/Explainable-AI]] para interpretação.
...
*Consulte também: [[05-Skills/Data-Cleaning]], [[05-Skills/Kaggle-Datasets]], [[05-Skills/Explainable-AI]], [[data-engineering/etl-pipelines]], [[02-software-engineering/algorithms-data-structures]].*

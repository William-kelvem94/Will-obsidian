...
- Roteiro e tratamento de incidentes de privacidade: [Workflow-Completo-Incident-Response.md](Knowledge-Base/LGPD-Privacidade/Projetos/Workflow-Completo-Incident-Response.md)
- Organização contra invasões e OpSec de infraestrutura: [[skills/devops/opsec-minimum]]
- Qualidade de dados e barreira contra poluição relacional: [Checklist-Qualidade-Dados-BI.md](Knowledge-Base/BI-Analytics/Checklists/Checklist-Qualidade-Dados-BI.md)

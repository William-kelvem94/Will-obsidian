...
- Arquitetura de integração com bancos de dados relacionais e vetoriais: [[skills/alloydb-basics/SKILL]]
- Tratamento de logs industriais de segurança: [[skills/devops/opsec-minimum]]
- Planejamento de projetos de Inteligência Artificial: [Knowledge-Base/IA-Aplicada/Projetos/POC-IA-Operacoes-Financeiras.md](Knowledge-Base/IA-Aplicada/Projetos/POC-IA-Operacoes-Financeiras.md)

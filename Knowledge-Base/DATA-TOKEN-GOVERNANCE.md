...
related: ["Knowledge-Base/TOKEN-ECONOMY", "Knowledge-Base/TOKEN-SHORTHAND", "JARVIS/TOKEN-COMPRESSION", "skills/04-knowledge-systems/INDEX"]
---
...
- [[Knowledge-Base/TOKEN-ECONOMY]] — Estratégias de otimização de tokens
- [[Knowledge-Base/TOKEN-SHORTHAND]] — Abreviações padronizadas
- [[JARVIS/TOKEN-COMPRESSION]] — Compressão de contexto JARVIS
- [[Templates/Template-Prompt-Otimizado]] — Template de prompt enxuto
- [[skills/04-knowledge-systems/INDEX]] — Sistemas de conhecimento e RAG
- [[skills/data-engineering/INDEX]] — Engenharia de dados
- [[skills/devops/FinOps]] — FinOps em nuvem
- [[skills/ai/LLMOps]] — LLMOps e monitoramento
- [[INDEX]]

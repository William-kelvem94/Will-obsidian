...
related: ["Knowledge-Base/TOKEN-SHORTHAND", "JARVIS/TOKEN-COMPRESSION", "Templates/Template-Prompt-Otimizado"]
---
...
→ Ver [[Knowledge-Base/TOKEN-SHORTHAND]] (lista completa de abreviações padronizadas)
...
- [[JARVIS/TOKEN-COMPRESSION]] — Compressão de contexto para o JARVIS
- [[Templates/Template-Prompt-Otimizado]] — Template de prompt otimizado
- [[Knowledge-Base/IA-APLICADA]] — Hub de IA Aplicada
- [[INDEX]]

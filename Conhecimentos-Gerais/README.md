...
Esta pasta é a camada de conhecimento amplo do vault. Ela serve para estudos, consulta por IA, organização de conceitos, economia de tokens e apoio ao JARVIS.
...
- [[02-Engenharia-Software/CI-CD-e-Entrega-Continua]] — apenas conhecimento geral, não workflow ativo.
...
- [[13-Financas/Financas-Pessoais-e-Metricas]]
- [[14-Comunicacao/Comunicacao-Clara-e-Reunioes]]
...
Documentação sobre CI/CD pode ficar nesta pasta como conhecimento geral. O que não deve existir no projeto sem intenção explícita é arquivo ativo em `.github/workflows/`, pois ele dispara automações reais, checks e notificações.

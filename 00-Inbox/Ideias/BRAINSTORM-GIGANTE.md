...
**Dificuldade**: Médio
**Status**: ✅ Implementado — `scripts/generate_flashcards.py` extrai dinamicamente 3.203 termos conceituais de Conhecimento-Geral sob regras semânticas puras para Anki de forma automatizada.

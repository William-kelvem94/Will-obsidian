...
type: moc
status: active
tags: [templates, modelos, organizacao]
summary: "Área global para modelos reutilizáveis do vault."
---

# Templates Globais

Esta pasta é o destino físico para modelos reutilizáveis do vault.
...
- `Templates/`
- `Conhecimentos-Gerais/99-Templates/`

## Regra

Templates globais devem ser fáceis de encontrar e reutilizar. Templates específicos de projeto podem ficar dentro do próprio projeto quando fizer sentido.

...
- [[skills/devops/Observabilidade|Observabilidade]] — Prometheus e Grafana em K8s
- [[skills/devops/FinOps|FinOps]] — Otimizacao de custos em clusters
- [[skills/ai/MLOps|MLOps]] — Deploy de modelos em K8s
- [[skills/03-infrastructure-mcp/mcp-servers|MCP Servers]] — Servidores MCP containerizados

...
Para um agente como o [[JARVIS/Main|JARVIS]] ter "personalidade" ou "consciência contínua", ele precisa lembrar de sessões antigas que já saíram da *janela de contexto*. A memória em sistemas de IA é um dos componentes mais críticos para construir agentes verdadeiramente inteligentes e contínuos.

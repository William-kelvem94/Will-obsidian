...
Este workflow define como um agente autônomo (como [[JARVIS/Main|JARVIS]] ou Antigravity) deve interagir com o vault e executar tarefas complexas de forma autônoma. Abrange desde loops básicos de raciocínio até arquiteturas multi-agente com supervisão humana.

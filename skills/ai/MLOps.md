...
- [[skills/ai/Reinforcement-Learning|Reinforcement Learning]] — RL para otimizacao continua de modelos
- [[skills/devops/FinOps|FinOps]] — Otimizacao de custos de treino e inferencia
- [[skills/devops/Kubernetes|Kubernetes]] — Orquestracao de servicos de ML
- [[skills/devops/Observabilidade|Observabilidade]] — Dashboards e alertas para modelos
- [[skills/04-knowledge-systems/INDEX|Knowledge Systems]] — RAG como pipeline MLOps

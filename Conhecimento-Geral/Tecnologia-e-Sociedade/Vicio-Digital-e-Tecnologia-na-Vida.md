---
title: "Vício Digital e o Papel da Tecnologia na Vida"
date: 2026-05-18
tags:
  - tecnologia
  - sociedade
...
mindmap
  root((Vício Digital))
    Psicologia
      ...
      Comparação social
      FOMO x JOMO
      Autocompaixão digital
    Neurociência
      Córtex pré-frontal
      Plasticidade neural
      Custos de troca de contexto
      Atenção seletiva x sustentada
      Loop dopamina - craving - recompensa
    Felicidade
      Satisfação com a vida
      Presença e mindfulness
      Conexão genuína vs superficial
      Tédio como porta para criatividade
      Prazer do ócio deliberado
    Produtividade
      Fluxo (flow)
      Deep work
      Gestão de atenção
      Task-switching cost
      Priorização x reatividade
    Saúde
      Sono (luz azul + estimulação)
    ...
    Economia
      ...
      Modelo de negócios de plataformas
      Economia de dados
      Regulação (GDPR, LGPD)
```

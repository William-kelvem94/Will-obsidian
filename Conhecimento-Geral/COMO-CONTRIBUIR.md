...
| [Knowledge-Base/](Knowledge-Base/) | Hubs técnicos condensados (KBs) de mercado. | Cada hub técnico possui sua pasta de recortes, glossários e projetos. |
| [skills/](skills/) | Inventário vivo de competências e trilhas curriculares. | Organizado por prefixado numérico (`01-...`, `02-...`). |
| [Conhecimento-Geral/](Conhecimento-Geral/) | Ramos transdisciplinares das Humanidades e Ciências. | Dividido em 20 subpastas estanques temáticas. |
...
related: ["Conhecimento-Geral/SubPasta/Nota-Correlata-1", "skills/02-software-engineering/Nota-Correlata-2"]
---
```
...
*   **Wikilinks com Caminho Completo**: De preferência, especifique o caminho completo a partir da raiz do cofre para evitar erros de desambiguação sintática no Obsidian (ex: `[[Conhecimento-Geral/Logica/INDEX]]`).

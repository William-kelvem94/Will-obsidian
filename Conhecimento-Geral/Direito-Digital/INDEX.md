...
1. **Fundamentos** — Comece pelo [[Conhecimento-Geral/Direito-Digital/GDPR-e-Privacidade|GDPR e Privacidade]] para entender os princípios básicos de proteção de dados.
2. **Regulação específica** — Avance para o [[Conhecimento-Geral/Direito-Digital/EU-AI-Act|EU AI Act]], que constrói sobre o GDPR com camadas específicas para IA.
3. **Governança** — Finalize com [[Conhecimento-Geral/Direito-Digital/Responsabilidade-e-Governanca|Responsabilidade e Governança]], consolidando os conceitos em frameworks de compliance e gestão de risco.

## Referências e conexões

- [[Conhecimento-Geral/Neurociencia/INDEX|Neurociência Cognitiva]] — Intersecção com ética em neurotech e neurodireitos.
- [[skills/02-software-engineering/INDEX|Engenharia de Software]] — Implementação técnica de _privacy by design_ e auditoria.
- [[Conhecimento-Geral/Matematica/Teoria-da-Informacao|Teoria da Informação]] — Base matemática para privacidade diferencial e criptografia.

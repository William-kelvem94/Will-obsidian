...
mindmap
  root((Confucionismo))
    Taoísmo
      Dao como caminho
      Wu Wei vs ação ritual
      Zhuangzi vs Confúcio
      Yin-Yang no Zhongyong
      Síntese no Neo-Confucionismo
      Cosmologia do Qi
    Budismo
      Natureza da mente
      Compaixão universal
      Meditação vs auto-cultivo
      Crítica da renúncia
      Escola Chan e Confucionismo
      Neo-Confucionismo como resposta
    Política
      Meritocracia
      Exames imperiais
      Mandato do Céu
    ...
    Cultura Asiática
      China: identidade nacional
      Coreia: Joseon e hoje
      Japão: samurai e empresa
      Vietnã: família e Estado
      Singapura: modelo político
      Diáspora chinesa
    Educação
      Aprendizado moral
      Quatro Livros
      Clássicos chineses
      Exames meritocráticos
      Formação do caráter
      Educação como auto-cultivo
    Sociologia
      Coletivismo
...
```mermaid
flowchart TD
    A[Confucionismo] --> B[Conceitos Centrais]
    A --> C[5 Relações]
    A --> D[Escola e História]
    A --> E[Educação]

    B --> B1[Ren: benevolência]
    B --> B2[Li: rituais]
    B --> B3[Xiao: piedade filial]
    B --> B4[Yi: retidão]
    B --> B5[Zhi: sabedoria]
    B --> B6[Xin: confiança]
    B --> B7[Junzi: homem nobre]

    C --> C1[Soberano-Súdito]
    C --> C2[Pai-Filho]
    C --> C3[Marido-Mulher]
    C --> C4[Irmão + / Irmão -]
    C --> C5[Amigo-Amigo]

    D --> D1[Confúcio . 551-479 a.C.]
    D --> D2[Mêncio . natureza boa]
    D --> D3[Xunzi . natureza má]
    D --> D4[Neo-Confucionismo]
    D --> D5[Confucionismo Imperial]

    D4 --> D4a[Zhu Xi . racionalismo]
    D4 --> D4b[Wang Yangming . intuição]

    E --> E1[Os Quatro Livros]
    E --> E2[Retificação dos Nomes]
    E --> E3[Doutrina do Meio]
```

```mermaid
gantt
    title Linha do Tempo do Confucionismo
    dateFormat YYYY
    axisFormat %Y

    section China Antiga
    Confúcio (551-479 a.C.)           :551, 72
    Mêncio (372-289 a.C.)             :372, 83
    Xunzi (310-235 a.C.)              :310, 75

    section China Imperial
    Dinastia Han (adoção oficial)      :206, 400
    Dinastia Song (Neo-Confucionismo) :960, 319
    Zhu Xi (1130-1200)                :1130, 70
    Wang Yangming (1472-1529)         :1472, 57

    section Era Moderna
    Fim dos exames imperiais (1905)    :1905, 1
    Revolução Cultural (anti-Confúcio) :1966, 10
    Renascimento contemporâneo        :2000, 26
```

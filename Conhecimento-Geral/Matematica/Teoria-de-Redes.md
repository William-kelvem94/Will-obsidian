...
- [[Conhecimento-Geral/Neurociencia/Redes-Neurais-Biologicas|Redes Neurais Biológicas]] — veja nota dedicada
...
- [[Conhecimento-Geral/Neurociencia/Redes-Neurais-Biologicas|Redes Neurais Biológicas]] — O cérebro como rede complexa: conectoma, small-world, plasticidade
- [[Conhecimento-Geral/Matematica/Teoria-da-Informacao|Teoria da Informação]] — Entropia de Shannon conecta-se à compressão de redes e overlap de comunidades
- [[Conhecimento-Geral/Matematica/Probabilidade-e-Estatistica|Probabilidade e Estatística]] — Distribuições de grau (Poisson, power law), modelos de percolação
- [[Conhecimento-Geral/Matematica/Algebra-Linear-Essencial|Álgebra Linear Essencial]] — Matriz de adjacência, autovalores, SVD, eigenvector centrality
- [[Conhecimento-Geral/Matematica/Calculo-e-Otimizacao|Cálculo e Otimização]] — Otimização em GNNs, gradiente descendente em GraphSAGE

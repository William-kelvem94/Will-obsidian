...
- [[Conhecimento-Geral/Matematica/Probabilidade-e-Estatistica|Probabilidade e Estatística]] — Base para modelos bayesianos do cérebro (cérebro bayesiano).
- [[skills/04-knowledge-systems/memory-management|Gestão de Memória]] — Implementação prática de sistemas de memória em agentes de IA.
- [[Conhecimento-Geral/Direito-Digital/EU-AI-Act|EU AI Act]] — Regulação de neurotech e neurodireitos.

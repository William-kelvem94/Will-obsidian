...
- **Frontend**: JavaScript, TypeScript, React, Next.js, HTML, CSS, Tailwind, UX, acessibilidade.
- **Backend**: Python (FastAPI, Flask), Node.js, TypeScript, C#, Java, PHP.
- **Banco de dados**: PostgreSQL, MySQL, SQLite, MongoDB, Redis, Prisma, SQLAlchemy.
- **Infraestrutura**: Docker, docker-compose, Traefik, CI/CD, Vercel, Docker Swarm.
- **APIs**: REST, GraphQL, WebSockets, integração com serviços externos.

## 2. Domínio de IA e Assistência
- **LLMs**: Ollama, Llama, Qwen, GPT-like.
- **RAG**: embeddings, FAISS, Chroma, search vector.
- **Voice**: LiveKit, Whisper, faster-whisper, Piper TTS.
- **Visão**: MediaPipe, YOLOv8, OCR Tesseract.
- **Automação**: Playwright, scripts de fluxo, comandos de browser.
